...
global_area_chinese = '白家庄'   #必须中文
global_area = 'baijiazhuang'    #必须拼音
global_city = 'bj'
global_district = 'chaoyang'
...
class ZuFangBaseSpider(BaseSpider):
        ...
        with open(csv_file, "w") as f:
            ...
            if fmt == "csv":
                for zufang in zufangs:
                    ...
                    #print('warning:'+zufang.name)
                    f.write(self.date_string + "," +  zufang.area + "," + zufang.xiaoqu + "," + zufang.layout + "," + zufang.size + "," + zufang.price + '\n')
    ...
    def get_area_zufang_info(city_name, area_name):
        ...
        zufang_list = list()
        page = 'http://{0}.{1}.com/zufang/rs{2}/'.format(city_name, SPIDER_NAME, global_area_chinese)
        print(page)
        ...
        for num in range(1, total_page + 1):
            page = 'http://{0}.{1}.com/zufang/pg{3}rs{2}'.format(city_name, SPIDER_NAME, global_area_chinese, num)
            print(page)
    ...
    def start(self):
        ...
        districts = list()
        districts.append(global_district)
...
if __name__ == '__main__':
    ...
    pass
    spider = ZuFangBaseSpider('BEIKE_SPIDER') 
    #spider.get_area_ershou_info('bj', 'hongmiao')
    spider.get_area_zufang_info('bj', 'gongyuandadao')